...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:301',
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'client-ui-deliverables TurnDeliverables',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@gongchuang/client-ui ImageTransferProviderNotice id \'gongchuang-image-transfer-provider\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui ProductHeroBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional product-owned blank-session headline.',
    doc: 'Optional product-owned blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui ProductHeroHeadline',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.hero.preview',
    kind: 'single',
    scope: 'root',
    summary: 'Optional product-owned replacement for the upstream preview badge.',
    doc: 'Optional product-owned replacement for the upstream preview badge.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui ProductHeroPreview',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.hero.workspace.createEnterprise',
    kind: 'single',
    scope: 'root',
    summary: 'Optional product-owned enterprise creation action in the Workspace picker.',
    doc: 'Optional product-owned enterprise creation action in the Workspace picker.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      '@gongchuang/client-ui EnterpriseCreationMenuItem',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui DocumentImportControl id \'gongchuang-document-import\'',
      '@gongchuang/client-ui DeepClarificationControl id \'gongchuang-deep-clarification\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.input.payload',
    kind: 'list',
    scope: 'session',
    summary: 'Draft file and annotation entries inside the composer card, before the editor.',
    doc: 'Draft file and annotation entries inside the composer card, before the editor.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui DocumentImportRail id \'gongchuang-document-import-rail\'',
      '@gongchuang/client-ui AnnotationDraftRail id \'gongchuang-annotation-draft-rail\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.payload\', () => ctx.slots.register(\n      { name: \'conversation.input.payload\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui ProductOverlay id \'gongchuang-product-pages\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      '@gongchuang/client-ui ProductSidebar',
