...
export const zh = {
  ...
  'sessionStartError.title': '无法新建会话',
  'operationError.title': '操作未完成',
  'operationError.retry': '重试',
  'operationError.dismiss': '关闭提示',
  'menu.addWorkspace': '新建企业空间',
  'menu.noWorkspace': '不在企业空间工作',
  'picker.search.aria': '搜索企业空间',
  'picker.search.placeholder': '搜索企业空间',
  'picker.empty': '无',
  'picker.loading': '正在加载企业空间…',
...
export const en = {
  ...
  'sessionStartError.title': 'Couldn’t start a new session',
  'operationError.title': 'Action not completed',
  'operationError.retry': 'Retry',
  'operationError.dismiss': 'Dismiss',
  'menu.addWorkspace': 'New enterprise space',
  'menu.noWorkspace': 'Work without an enterprise space',
  'picker.search.aria': 'Search enterprise spaces',
  'picker.search.placeholder': 'Search enterprise spaces',
  'picker.empty': 'None',
  'picker.loading': 'Loading enterprise spaces…',
