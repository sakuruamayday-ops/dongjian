...
import { ConversationDraftTextController } from './draft-text.ts'
import { ConversationDraftImagesController } from './draft-images.ts'
...
export function apply(ctx: Context, config: Config = Config({})): void {
  ...
  ctx.provide('conversationDraftText', new ConversationDraftTextController(inputHub))
  ctx.provide('conversationDraftImages', new ConversationDraftImagesController(inputHub, () => concreteConversation(ctx)))
  ...
  const registerComposerBar = () => slots.register({
    ...
    children: {
      ...
      'conversation.input.payload': { kind: 'list', scope: 'session' },
