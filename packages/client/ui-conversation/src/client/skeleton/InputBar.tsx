...
export const InputBar = memo(function InputBar({
  ...
  const empty = draft.trim() === '' && attachments.length === 0 && input?.externalPayload !== true
    ...
    <div className={clsx(css.root, variant === 'hero' && css.hero)}>
      ...
      >
        ...
        {input === undefined || sessionId === undefined
          ? null
          : renderSlot('conversation.input.payload', { input })}
        ...
        <div className={css.row}>
          <div className={css.tools}>
            ...
            {input === undefined || sessionId === undefined
              ? null
              : renderSlot('conversation.input.left', { locked: locked || machineBusy, onAddFiles: intakeFiles })}
          </div>
