    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* The product-owned brand mark leads the headline in a stable 34px hitbox. */}
          <span
          ...
          <span className={css.headlineText}>
            {renderSlot('conversation.hero.headline', {}, { fallback: t('hero.headline') })}
          </span>
          {renderSlot('conversation.hero.preview', {}, {
