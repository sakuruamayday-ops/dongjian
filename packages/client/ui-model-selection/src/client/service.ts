...
export class ModelDirectoryResolver extends Service {
  ...
  /** Localized recovery copy for an explicit refresh that returns no models. */
   ...
   */
  constructor(ctx: Context, config: { blockReason: () => string; emptyCatalogReason: () => string }) {
    super(ctx, 'modelDirectories')
    this.blockReason = config.blockReason
    this.emptyCatalogReason = config.emptyCatalogReason
