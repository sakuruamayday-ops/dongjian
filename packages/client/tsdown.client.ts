...
function styleInjectionModule(
  ...
  const source = [
    ...
    'const cssRegistryKey = "__DSH_PLUGIN_CSS_REGISTRY__";',
    'if (typeof globalThis !== "undefined") {',
    '  const registry = globalThis[cssRegistryKey] instanceof Map ? globalThis[cssRegistryKey] : new Map();',
    '  registry.set(tagId, css);',
    '  globalThis[cssRegistryKey] = registry;',
    '}',
