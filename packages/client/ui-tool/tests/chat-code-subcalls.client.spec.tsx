...
import {
  apply as applyConversation, inject as injectConversation, type ConvViewOwnerProps,
...
async function bench(snapshot: ChatSnapshot) {
  ...
  const binding = ctx.uiConversation.binding(SID)
  vi.spyOn(binding, 'target').mockReturnValue(chat)
