...
export const zh = {
  ...
  'annotations.roundItem': '第 {round} 次标注 · 注释 {index}',
  ...
  'files.save': '保存副本',
  'files.loading': '正在读取可用应用…',
  'files.failed': '操作未完成，请确认文件仍存在或重试',
  'files.file': '文件',
  ...
  'chat.waitingForUser': '等待你回复',
  'reasoning.nonChinese.running': '正在处理…',
  'reasoning.nonChinese.completed': '思考已完成',
  ...
  'selection.addToConversation': '添加到对话',
...
export const en = {
  ...
  'annotations.roundItem': 'Submission {round}, annotation {index}',
  'annotations.close': 'Close annotations',
  'files.open': 'Open {name}',
  'files.openWith': 'Open with',
  'files.default': 'Default app',
  'files.other': 'Choose another app…',
  'files.reveal': 'Show in folder',
  'files.save': 'Save a copy',
  'files.loading': 'Loading applications…',
  'files.failed': 'Could not complete the action. Check the file and try again.',
  'files.file': 'File',
  'number.groupSeparator': ',',
  ...
  'chat.waitingForUser': 'Waiting for your response',
  'reasoning.nonChinese.running': 'Processing…',
  'reasoning.nonChinese.completed': 'Thinking completed',
  ...
  'selection.addToConversation': 'Add to conversation',
