...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  node, cwd, openFile, fileActions, forkAt, renderSlot, renderSlotChain, t, useChat,
  ...
  const owner: TurnTailOwnerProps = { turn, seq: closing?.finalNode.seq ?? data.seq, cwd, openFile, fileActions }
