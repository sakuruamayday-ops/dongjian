...
export interface DeepSeekFilesControl {
  /**
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.provide('deepseekFilesControl', {
    releaseAll: signal => adapter.releaseAllFiles(signal),
  })
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    /** Provider-owned Files lifecycle exposed without publishing credentials or file ids. */
    deepseekFilesControl: DeepSeekFilesControl
  }
}
