...
export interface ISessions {
  ...
  /**
   * Fork completed history into a selected Workspace without mutating the source.
   * This narrow operation is reserved for the Workspace navigation service.
   * @param opts - source Session, target Workspace, and target working directory.
   * @returns the copied Session id.
   */
  forkToWorkspace(opts: {
    sessionId: SessionId
    workspaceId: WorkspaceId
    cwd: string
  }): Promise<SessionId>
