...
import { GONGCHUANG_REMOTE_CONTRIBUTIONS } from './gongchuang-contributions.ts'
...
} from '@gongchuang/connectors/types'
export type {} from '@gongchuang/connectors/remote'
export type {
  InstalledSkillView,
  MarketplaceRepositoryView,
  MarketplaceSkillView,
  SkillEnabledSetReceipt,
  SkillEnabledSetRequest,
  SkillInstallReceipt,
  SkillInstallRequest,
  ...
  SkillRemoveReceipt,
  SkillRemoveRequest,
  SkillRepositoryAddReceipt,
  SkillRepositoryAddRequest,
  SkillRepositoryRemoveReceipt,
  SkillRepositoryRemoveRequest,
  SkillSearchPage,
  SkillSearchRequest,
} from '@gongchuang/skill-marketplace/types'
export type {} from '@gongchuang/skill-marketplace/remote'
export type {
  AutomationBindSessionRequest,
  AutomationClaim,
  AutomationCompleteRequest,
  AutomationCreateRequest,
  AutomationDeleteRequest,
  AutomationEnableRequest,
  AutomationLastRunView,
  AutomationRunId,
...
} from '@gongchuang/local-automation/types'
export type {} from '@gongchuang/local-automation/remote'
export type {
  GongchuangGraphMemoryConfigureRequest,
  GongchuangGraphMemorySnapshot,
} from '@gongchuang/graph-memory/types'
export type {} from '@gongchuang/graph-memory/remote'
export type {
  GongchuangAccountDisconnectRequest,
  GongchuangAccountLoginRequest,
  GongchuangAccountPhase,
  GongchuangAccountSnapshot,
  GongchuangClientCompatibility,
  GongchuangPersonalizationSaveRequest,
  GongchuangPersonalizationSnapshot,
} from '@gongchuang/account/types'
export type {} from '@gongchuang/account/remote'
export type {
  GongchuangCustomApiProtocol,
  ...
  GongchuangModelConnectionPhase,
...
} from '@gongchuang/model-connections/types'
export type {} from '@gongchuang/model-connections/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      ...GONGCHUANG_REMOTE_CONTRIBUTIONS,
    ]) {
