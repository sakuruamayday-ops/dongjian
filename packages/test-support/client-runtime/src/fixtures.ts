...
/**
 * A complete Workspace row for Client fixtures.
 * @param overrides - fields owned by the scenario.
 * @returns a stable row with every production management field present.
 */
export function workspaceView(overrides: Partial<WorkspaceView> = {}): WorkspaceView {
  return {
