...
/**
 * Service implementation for recaller.
 */
export class Recaller {
  ...
  /**
 * Perform the set embed fn operation through the owning service.
 ...
 */
  ...
  /**
 * Perform the recall operation through the owning service.
 * @param query - The query value.
 * @returns The recall result.
 */
