...
Source: [`packages/product/gongchuang-account/src/index.ts:45`](../packages/product/gongchuang-account/src/index.ts)
...
Source: [`packages/guard/gongchuang-policy-gate/src/index.ts:83`](../packages/guard/gongchuang-policy-gate/src/index.ts)

<a id="gongchuangconnectors"></a>

## `@gongchuang/connectors`

Requires: `settings` · `credentials` · `tools` · `web` · `gongchuangAccount`
...
Source: [`packages/mcp/gongchuang-connectors/src/index.ts:69`](../packages/mcp/gongchuang-connectors/src/index.ts)
...
Source: [`packages/credentials/gongchuang-keychain/src/index.ts:23`](../packages/credentials/gongchuang-keychain/src/index.ts)

<a id="gongchuanggraph-memory"></a>

## `@gongchuang/graph-memory`

Requires: `tools` · `llm` · `systemPrompt` · `workspaceRegistry`
...
Source: [`packages/product/gongchuang-graph-memory/src/index.ts:38`](../packages/product/gongchuang-graph-memory/src/index.ts)
...
- `@gongchuang/local-automation` — requires `tools` ([`packages/product/gongchuang-local-automation/src/index.ts`](../packages/product/gongchuang-local-automation/src/index.ts))
- `@gongchuang/model-connections` — requires `credentials` · `settings` · `llm` ([`packages/product/gongchuang-model-connections/src/index.ts`](../packages/product/gongchuang-model-connections/src/index.ts))
- `@gongchuang/signed-skill-runtime` — requires `tools` · `subprocess` · `sandbox` · `gongchuangPolicy` · `gongchuangSkillRuntimeBinding` ([`packages/product/gongchuang-signed-skill-runtime/src/index.ts`](../packages/product/gongchuang-signed-skill-runtime/src/index.ts))
- `@gongchuang/skill-marketplace` — requires `skills` ([`packages/skill/gongchuang-skill-marketplace/src/index.ts`](../packages/skill/gongchuang-skill-marketplace/src/index.ts))
