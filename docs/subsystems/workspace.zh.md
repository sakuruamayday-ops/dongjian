...
interface Workspace {
  ...
  /** Sessions explicitly pinned in user action order; every id is accounted by {@link sessionIds}. */
  ...
  /**
   * Set one accounted session's pinned state durably. Pinning moves the
   * session to the front of the manual order; unpinning preserves its current
   * position. Repeating the settled state is a no-op.
   * @param sessionId - The accounted session to update.
 ...
 */
@Remote('archiveSession') archiveSession(request: WorkspaceArchiveSessionRequest): Promise<WorkspaceManagementValue>

/**
 * Pin or unpin one accounted Session.
 * @param request - Session identity and desired pinned state.
 * @returns the updated Workspace projection.
 */
@Remote('setSessionPinned') setSessionPinned(request: WorkspaceSetSessionPinnedRequest): Promise<WorkspaceValue>

/**
 * Hide one Workspace registration from active lists.
 * @param request - Workspace identity to archive.
 * @returns the complete resulting management state.
 */
@Remote('archiveWorkspace') archiveWorkspace(request: WorkspaceManagementRequest): Promise<WorkspaceManagementValue>
 ...
 * @returns the complete resulting management state.
 */
@Remote('unarchiveWorkspace') unarchiveWorkspace(request: WorkspaceManagementRequest): Promise<WorkspaceManagementValue>

/**
 * Hide one Workspace registration behind a recoverable tombstone.
 * @param request - Workspace identity to hide.
 * @returns the complete resulting management state.
 */
@Remote('deleteWorkspace') deleteWorkspace(request: WorkspaceManagementRequest): Promise<WorkspaceManagementValue>
 ...
 * @returns the complete resulting management state.
 */
@Remote('unarchiveSession') unarchiveSession(request: WorkspaceSessionManagementRequest): Promise<WorkspaceManagementValue>
 ...
 * @returns the complete resulting management state.
 */
@Remote('deleteSession') deleteSession(request: WorkspaceSessionManagementRequest): Promise<WorkspaceManagementValue>
