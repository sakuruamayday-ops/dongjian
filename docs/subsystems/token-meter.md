...
interface ModelCostDayProjection {
...
interface ModelCostProjection extends ModelCostDayProjection {
...
The model-cost projection separates priced and unpriced requests, and groups the same cumulative list-price estimate by the host's local calendar day.
