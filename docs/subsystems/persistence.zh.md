...
<a id="ctxgongchuanggraphmemory--gongchuanggraphmemoryservice"></a>

### `ctx.gongchuangGraphMemory` — `GongchuangGraphMemoryService`
 ...
 */
@Remote('snapshot') async snapshot(): Promise<GongchuangGraphMemorySnapshot>
 ...
 */
@Remote('configure') configure(request: GongchuangGraphMemoryConfigureRequest): Promise<GongchuangGraphMemorySnapshot>
 ...
 */
@Remote('clearAll') clearAll(): Promise<GongchuangGraphMemorySnapshot>
```

Types: [GongchuangGraphMemoryConfigureRequest](../../packages/product/gongchuang-graph-memory/README.zh.md) · [GongchuangGraphMemorySnapshot](../../packages/product/gongchuang-graph-memory/README.zh.md)

Source: [`packages/product/gongchuang-graph-memory/src/index.ts`](../../packages/product/gongchuang-graph-memory/src/index.ts)
