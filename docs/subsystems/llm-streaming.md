...
interface ContentBlockMap {
  ...
  'image': ImageBlock
  'image-description': ImageDescriptionBlock
  'file': FileBlock
...
The block interfaces (full fields in source): `TextBlock` (`text`), `ReasoningBlock` (thinking, distinct from visible text), `ImageBlock` (a durable [image attachment](attachment.md)), `ImageDescriptionBlock` (OCR or vision fallback text bound to one exact image), `FileBlock` (a durable verbatim [file attachment](attachment.md) that request assembly projects to handle text for every route), `ToolCallBlock` (`id: ToolCallId`, `name`, raw-JSON `arguments`), and `ToolResultBlock` (`toolCallId`, nested `content: ContentBlock[]`, `isError?`). `ContentBlock = ContentBlockMap[ContentBlockType]`. A new modality belongs in the merge-extensible map only when its adapter, UI, compaction, and durable replay paths honor it.
...
interface TokenUsage {
  ...
  /**
   * Estimated USD charge for this request at the adapter's current list
   * price. This is a reference figure, not an invoice: subscription credits,
   * provider promotions, taxes, and later price changes are not reconciled.
   * Absent means the adapter has no trustworthy price for the exact route and
   * model; zero is a known free request.
   */
...
<a id="ctxdeepseekfilescontrol--deepseekfilescontrol"></a>

### `ctx.deepseekFilesControl` — `DeepSeekFilesControl`

Product-facing control for the provider-owned Files lifecycle.

```ts cordis-catalog
/**
 * Delete every Harness-owned remote file for the active endpoint and credential scope.
...
Source: [`packages/llm/llm-deepseek/src/index.ts`](../../packages/llm/llm-deepseek/src/index.ts)
...
<a id="ctxgongchuangmodelconnections--gongchuangmodelconnectionsservice"></a>

### `ctx.gongchuangModelConnections` — `GongchuangModelConnectionsService`
 ...
 */
@Remote('snapshot') async snapshot(): Promise<GongchuangModelConnectionsSnapshot>
 ...
 */
@Remote('deepseekFiles') deepseekFiles(): GongchuangDeepSeekFilesView
 ...
 */
@Remote('setDeepSeekFileRetention') setDeepSeekFileRetention( request: GongchuangDeepSeekFileRetentionRequest, ): Promise<GongchuangDeepSeekFilesView>
 ...
 */
@Remote('clearDeepSeekFiles') clearDeepSeekFiles(): Promise<GongchuangDeepSeekFilesCleanupReceipt>
 ...
 */
@Remote('refresh') refresh(request: GongchuangModelRefreshRequest): Promise<GongchuangModelConnectionsSnapshot>
 ...
 */
@Remote('configure') configure(request: GongchuangModelConfigureRequest): Promise<GongchuangModelConnectionsSnapshot>
```

Types: [GongchuangDeepSeekFileRetentionRequest](../../packages/product/gongchuang-model-connections/README.md) · [GongchuangDeepSeekFilesCleanupReceipt](../../packages/product/gongchuang-model-connections/README.md) · [GongchuangDeepSeekFilesView](../../packages/product/gongchuang-model-connections/README.md) · [GongchuangModelConfigureRequest](../../packages/product/gongchuang-model-connections/README.md) · [GongchuangModelConnectionsSnapshot](../../packages/product/gongchuang-model-connections/README.md) · [GongchuangModelRefreshRequest](../../packages/product/gongchuang-model-connections/README.md)

Source: [`packages/product/gongchuang-model-connections/src/index.ts`](../../packages/product/gongchuang-model-connections/src/index.ts)
