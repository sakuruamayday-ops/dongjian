...
<a id="ctxgongchuangsignedskillruntime--gongchuangsignedskillruntime"></a>

### `ctx.gongchuangSignedSkillRuntime` — `GongchuangSignedSkillRuntime`
...
Types: [GongchuangSkillOperationResult](../../packages/product/gongchuang-signed-skill-runtime/README.zh.md) · [ToolExecution](tools.zh.md)

Source: [`packages/product/gongchuang-signed-skill-runtime/src/index.ts`](../../packages/product/gongchuang-signed-skill-runtime/src/index.ts)

<a id="ctxgongchuangskillmarketplace--gongchuangskillmarketplaceservice"></a>

### `ctx.gongchuangSkillMarketplace` — `GongchuangSkillMarketplaceService`
 ...
 */
@Remote('snapshot') async snapshot(): Promise<SkillMarketplaceSnapshot>
 ...
 */
@Remote('search') async search(request: SkillSearchRequest): Promise<SkillSearchPage>
 ...
 */
@Remote('addRepository') async addRepository(request: SkillRepositoryAddRequest): Promise<SkillRepositoryAddReceipt>
 ...
 */
@Remote('removeRepository') async removeRepository(request: SkillRepositoryRemoveRequest): Promise<SkillRepositoryRemoveReceipt>
 ...
 */
@Remote('installSkill') async install(request: SkillInstallRequest): Promise<SkillInstallReceipt>
 ...
 */
@Remote('removeSkill') async remove(request: SkillRemoveRequest): Promise<SkillRemoveReceipt>
 ...
 */
@Remote('setSkillEnabled') async setEnabled(request: SkillEnabledSetRequest): Promise<SkillEnabledSetReceipt>
```

Types: [SkillEnabledSetReceipt](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillEnabledSetRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillInstallReceipt](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillInstallRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillMarketplaceSnapshot](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRemoveReceipt](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRemoveRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRepositoryAddReceipt](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRepositoryAddRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRepositoryRemoveReceipt](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillRepositoryRemoveRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillSearchPage](../../packages/skill/gongchuang-skill-marketplace/README.zh.md) · [SkillSearchRequest](../../packages/skill/gongchuang-skill-marketplace/README.zh.md)

Source: [`packages/skill/gongchuang-skill-marketplace/src/index.ts`](../../packages/skill/gongchuang-skill-marketplace/src/index.ts)

<a id="ctxgongchuangskillruntimebinding--gongchuangskillruntimebinding"></a>

### `ctx.gongchuangSkillRuntimeBinding` — `GongchuangSkillRuntimeBinding`
