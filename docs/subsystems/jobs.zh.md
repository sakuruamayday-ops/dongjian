...
<a id="ctxgongchuanglocalautomation--gongchuanglocalautomationservice"></a>

### `ctx.gongchuangLocalAutomation` — `GongchuangLocalAutomationService`
 ...
 */
@Remote('snapshot') async snapshot(): Promise<AutomationSnapshot>
 ...
 */
@Remote('createTask') async createTask(request: AutomationCreateRequest): Promise<AutomationTaskView>
 ...
 */
@Remote('updateTask') async updateTask(request: AutomationUpdateRequest): Promise<AutomationTaskView>
 ...
 * @returns Updated persisted task state.
 */
@Remote('setTaskEnabled') async setTaskEnabled(request: AutomationEnableRequest): Promise<AutomationTaskView>
 ...
 */
@Remote('deleteTask') async deleteTask(request: AutomationDeleteRequest): Promise<{ id: AutomationTaskId }>
 ...
 */
@Remote('claimDue') async claimDue(): Promise<AutomationClaim | null>
 ...
 */
@Remote('runTaskNow') async runTaskNow(request: AutomationRunRequest): Promise<AutomationClaim>
 ...
 */
@Remote('bindRunSession') async bindRunSession(request: AutomationBindSessionRequest): Promise<AutomationTaskView>
 ...
 */
@Remote('dispatchRun') async dispatchRun(request: AutomationDispatchRequest): Promise<{ requestId: SessionRequestId }>
 ...
 */
@Remote('completeRun') async completeRun(request: AutomationCompleteRequest): Promise<AutomationTaskView | null>
```

Types: [AutomationBindSessionRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationClaim](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationCompleteRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationCreateRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationDeleteRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationDispatchRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationEnableRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationRunRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationSnapshot](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationTaskId](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationTaskView](../../packages/product/gongchuang-local-automation/README.zh.md) · [AutomationUpdateRequest](../../packages/product/gongchuang-local-automation/README.zh.md) · [SessionRequestId](session.zh.md)

Source: [`packages/product/gongchuang-local-automation/src/index.ts`](../../packages/product/gongchuang-local-automation/src/index.ts)
