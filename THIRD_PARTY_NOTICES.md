...
| [`@napi-rs/canvas-win32-x64-msvc`](https://github.com/Brooooooklyn/canvas) | MIT |
...
The packaged macOS client dynamically loads the following unmodified prebuilt shared-library payloads through `sharp`. The project owner authorizes distribution only for these exact package identities at version 1.3.2; any identity, version, declared-license, binary, or component-set change requires a new distribution review.

| Package | Version | Declared license |
| --- | --- | --- |
| [`@img/sharp-libvips-darwin-arm64`](https://www.npmjs.com/package/@img/sharp-libvips-darwin-arm64) | 1.3.2 | LGPL-3.0-or-later |
| [`@img/sharp-libvips-darwin-x64`](https://www.npmjs.com/package/@img/sharp-libvips-darwin-x64) | 1.3.2 | LGPL-3.0-or-later |

The GNU GPLv3 and LGPLv3 texts, the exact upstream component notices and versions, and the corresponding-source and relinking information are bundled in [`apps/desktop/assets/licenses/sharp-libvips-1.3.2/`](apps/desktop/assets/licenses/sharp-libvips-1.3.2/). The same directory is copied into every packaged macOS application at `Contents/Resources/product/brand/licenses/sharp-libvips-1.3.2/`.
