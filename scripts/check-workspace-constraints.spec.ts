...
describe('package payload constraints', () => {
  it('keeps product-owned workspace packages private instead of treating them as npm release members', () => {
    expect(checkWorkspaceManifest({
      dir: 'packages/product/gongchuang-account',
      manifest: { name: '@gongchuang/account', private: true },
    })).toEqual([])
    expect(checkWorkspaceManifest({
      dir: 'apps/desktop',
      manifest: { name: '@gongchuang/desktop', private: true },
    })).toEqual([])
  })
