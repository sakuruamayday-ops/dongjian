...
import { clientSourceRoot, clientUiI18nIncluded, findUiI18nViolations } from './verify-client-ui-i18n.ts'
...
describe('Client UI i18n source check', () => {
  ...
  it('does not impose the shared locale contract on the Chinese-only product surface', () => {
    expect(clientUiI18nIncluded('packages/client/ui-gongchuang-product/src/client/ProductShell.tsx')).toBe(false)
    expect(clientUiI18nIncluded('packages/client/ui-session/src/client/SessionView.tsx')).toBe(true)
  })
