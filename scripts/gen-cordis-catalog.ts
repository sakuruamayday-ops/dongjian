...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  deepseekFilesControl: 'llm-streaming.md',
  ...
  fs: 'filesystem.md',
  goals: 'goal.md',
  gongchuangAccount: 'credentials.md',
  gongchuangGraphMemory: 'persistence.md',
  gongchuangLocalAutomation: 'jobs.md',
  gongchuangModelConnections: 'llm-streaming.md',
  gongchuangPolicy: 'tools.md',
  gongchuangSignedSkillRuntime: 'skills.md',
  gongchuangSkillRuntimeBinding: 'skills.md',
  gongchuangSkillMarketplace: 'skills.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  hostModuleBaseUrl: 'not a service: optional packaged-host module-resolution base provided before Loader composition — packages/boot/app-boot/README.md owns the boot contract',
  gongchuangArtifactRenderer: 'interface-typed private desktop-host capability supplied before policy composition — packages/guard/gongchuang-policy-gate/README.md owns the contract',
  ...
  chatUserMessageFiles: 'client-side product-owned user-message file projection — packages/client/ui-chat/README.md owns the API',
  chatSelectionAnnotations: 'client-side product-owned numbered selection drafts — packages/client/ui-chat/README.md owns the API',
  ...
  conversationDraftText: 'client-side text draft persistence service — packages/client/ui-conversation/README.md owns the API',
  conversationDraftImages: 'client-side image draft persistence service — packages/client/ui-conversation/README.md owns the API',
  conversationPromptPreparation: 'client-side product-owned one-shot prompt preparation service — packages/client/ui-conversation/README.md owns the API',
  conversationPromptAdmission: 'client-side product-owned prompt admission service — packages/client/ui-conversation/README.md owns the API',
  ...
  modelCatalogRefresh: 'client-side optional product refresh service — packages/client/ui-model-selection/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'fs': 'filesystem.md',
  'goal': 'goal.md',
  'gongchuang-connectors': 'tools.md',
  'llm': 'llm-streaming.md',
  'mcp': 'tools.md',
  'session': 'session.md',
  'settings': 'settings.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ArtifactBinding: '../../packages/guard/gongchuang-policy-gate/README.md',
  ProfessionalEvidence: '../../packages/guard/gongchuang-policy-gate/README.md',
  EvidenceReceipt: '../../packages/guard/gongchuang-policy-gate/README.md',
  GongchuangAccountDisconnectRequest: '../../packages/product/gongchuang-account/README.md',
  GongchuangAccountLoginRequest: '../../packages/product/gongchuang-account/README.md',
  GongchuangAccountSnapshot: '../../packages/product/gongchuang-account/README.md',
  GongchuangPersonalizationSaveRequest: '../../packages/product/gongchuang-account/README.md',
  GongchuangPersonalizationSnapshot: '../../packages/product/gongchuang-account/README.md',
  GongchuangModelConnectionsSnapshot: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangModelRefreshRequest: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangModelConfigureRequest: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangDeepSeekFilesView: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangDeepSeekFileRetentionRequest: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangDeepSeekFilesCleanupReceipt: '../../packages/product/gongchuang-model-connections/README.md',
  GongchuangGraphMemoryConfigureRequest: '../../packages/product/gongchuang-graph-memory/README.md',
  GongchuangGraphMemorySnapshot: '../../packages/product/gongchuang-graph-memory/README.md',
  GongchuangSkillOperationResult: '../../packages/product/gongchuang-signed-skill-runtime/README.md',
  AutomationClaim: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationBindSessionRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationCompleteRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationCreateRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationDeleteRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationDispatchRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationEnableRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationRunRequest: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationSnapshot: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationTaskId: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationTaskView: '../../packages/product/gongchuang-local-automation/README.md',
  AutomationUpdateRequest: '../../packages/product/gongchuang-local-automation/README.md',
  SkillInstallReceipt: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillInstallRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillEnabledSetReceipt: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillEnabledSetRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillMarketplaceSnapshot: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRemoveReceipt: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRemoveRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRepositoryAddReceipt: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRepositoryAddRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRepositoryRemoveReceipt: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillRepositoryRemoveRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillSearchPage: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  SkillSearchRequest: '../../packages/skill/gongchuang-skill-marketplace/README.md',
  ...
  WorkspaceManagementRequest: 'workspace.md',
  WorkspaceManagementValue: 'workspace.md',
  WorkspaceOrderValue: 'workspace.md',
  WorkspaceRenameRequest: 'workspace.md',
  WorkspaceSessionManagementRequest: 'workspace.md',
  WorkspaceSetSessionPinnedRequest: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  McpConnectionState: 'connection lifecycle fields are owned by packages/mcp/mcp-client/README.md',
  ...
  ProfessionalLedger: 'service-local professional evidence checkpoint is owned by packages/guard/gongchuang-policy-gate/src/index.ts',
