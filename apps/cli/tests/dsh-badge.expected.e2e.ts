...
describe('dsh badge assembled snapshot', () => {
  it('advertises and loads the opt-in bundled skill through the shipped app', async () => {
    ...
    expect(enabledSnapshot).toMatchInlineSnapshot(`
      ...
      Before calling a file tool for a referenced resource, join its relative path to this exact base directory. Never pass a referenced basename or relative path directly to a file tool. Load referenced resources only as needed.
      </skill_resources>
