...
- text: Produced
- button "Open site/report.html":
  - img
  - text: report.html File · HTML
- button "Open a/style.css":
  - img
  - text: style.css File · CSS
- button "Open b/style.css":
  - img
  - text: style.css File · CSS
- button "Open site/index.html":
  - img
  - text: index.html File · HTML
- button "Open site/app.js":
  - img
  - text: app.js File · JS
- button "Open src/tokens.css":
  - img
  - text: tokens.css File · CSS
- button "+ 1 file"
